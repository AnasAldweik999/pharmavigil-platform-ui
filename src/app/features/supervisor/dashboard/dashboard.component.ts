...
import { SavedChartsTabComponent } from './saved-charts-tab/saved-charts-tab.component';

type DashboardTab = 'reports' | 'summary' | 'products' | 'saved-charts';

@Component({
  selector: 'app-supervisor-dashboard',
  imports: [ReportsTabComponent, SummaryTabComponent, ProductsTabComponent, SavedChartsTabComponent],
...
export class SupervisorDashboardComponent implements OnInit {
  ...
  readonly tabs: { key: DashboardTab; label: string }[] = [
    ...
    { key: 'saved-charts', label: 'Saved Charts' },
  ];
